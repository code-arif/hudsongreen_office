        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Comprehensive Fitness Tests</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
                        <div class="card box-shadow-0">
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="{{ route('cms.store.fitness-test.section') }}"
                        ...
                        <div class="card box-shadow-0">
                            <div class="card-body">
                                <div class="card-header border-bottom">
                                    <h3 class="card-title mb-0">Data List</h3>
            ...
            <div class="modal-content">
                <form id="itemForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="itemModalLabel">Add Fitness Test Item</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3" id="image_show_section">
                                    <label class="form-label">Item Item</label>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('cms.fitness-test.section') }}",
                        type: "GET",
                    },
            ...
            $('#itemForm').on('submit', function(e) {
                ...
                var id = $('#itemID').val();
                var url = id ? "{{ route('cms.fitness-test.item.update', ':id') }}".replace(':id', id) :
                    "{{ route('cms.fitness-test.item.store') }}";
            ...
            $(document).on('click', '.editItem', function() {
                var id = $(this).data('id');
                var url = "{{ route('cms.fitness-test.item.edit', ':id') }}".replace(':id', id);
        ...
        function deleteItem(id) {
            NProgress.start();
            let url = "{{ route('cms.fitness-test.item.destroy', ':id') }}";
