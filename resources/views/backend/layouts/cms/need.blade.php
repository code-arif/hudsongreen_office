        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">How it works - Everything you need</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
                        <div class="card box-shadow-0">
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="{{ route('cms.store.need.section') }}"
            ...
            <div class="modal-content">
                <form id="itemForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="itemModalLabel">Add Carousel Image</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#itemForm').on('submit', function(e) {
                ...
                var id = $('#itemID').val();
                var url = id ? "{{ route('cms.need.item.update', ':id') }}".replace(':id', id) :
                    "{{ route('cms.need.item.store') }}";
            ...
            $(document).on('click', '.editItem', function() {
                var id = $(this).data('id');
                var url = "{{ route('cms.need.item.edit', ':id') }}".replace(':id', id);
        ...
        function deleteItem(id) {
            NProgress.start();
            let url = "{{ route('cms.need.item.destroy', ':id') }}";
