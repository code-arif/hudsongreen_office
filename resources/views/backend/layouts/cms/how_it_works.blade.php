                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
                        <div class="card box-shadow-0">
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="{{ route('cms.store.how-it-works.section') }}"
            ...
            <div class="modal-content">
                <form id="itemForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="itemModalLabel">Add How it works item</h5>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('cms.how-it-works.section') }}",
                        type: "GET",
                    },
            ...
            $('#itemForm').on('submit', function(e) {
                ...
                var id = $('#itemID').val();
                var url = id ? "{{ route('cms.how-it-works.item.update', ':id') }}".replace(':id', id) :
                    "{{ route('cms.how-it-works.item.store') }}";
            ...
            $(document).on('click', '.editItem', function() {
                var id = $(this).data('id');
                var url = "{{ route('cms.how-it-works.item.edit', ':id') }}".replace(':id', id);
        ...
        function deleteItem(id) {
            NProgress.start();
            let url = "{{ route('cms.how-it-works.item.destroy', ':id') }}";
