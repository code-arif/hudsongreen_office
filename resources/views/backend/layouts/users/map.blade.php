...
@section('title', 'Employee Work Map')
    ...
    <script>
        function initMap() {
            ...
            const directionsRenderer = new google.maps.DirectionsRenderer({
                map: map,
                suppressMarkers: true, // we’ll draw our own
                polylineOptions: {
                    strokeWeight: 6,
                    strokeOpacity: 0.8,
                },
            ...
            // Step 2: Request a route that follows real roads
            directionsService.route({
                origin,
                destination,
                waypoints,
                travelMode: google.maps.TravelMode.DRIVING,
                optimizeWaypoints: false, // maintain actual work order
            }, (response, status) => {
                if (status !== 'OK') {
                ...
                // Step 3: Customize polyline colors by status
                ...
                route.legs.forEach((leg, index) => {
                    ...
                    // Draw individual polyline segment
                ...
                validWorks.forEach((work, index) => {
                    ...
                    // Create a custom SVG pin with index number
                    const svgMarker = {
                ...
                // Step 5: Center map to fit everything
                ...
                // Step 6: Show total distance/time summary
