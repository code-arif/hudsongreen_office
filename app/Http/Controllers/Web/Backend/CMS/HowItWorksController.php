...
class HowItWorksController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $itemData = CMS::where('page', 'how-it-works')->where('section', 'how-it-works')->where('name', 'card')->get();
        ...
        $data = CMS::where('page', 'how-it-works')->where('section', 'how-it-works')->where('name', 'item')->first();

        return view("backend.layouts.cms.how_it_works", compact("data"));
    }
    ...
    public function storeItem(CmsRequest $request)
    {
        try {
            ...
            if ($request->hasFile('image')) {
                $imagePath = Helper::uploadImage($request->file('image'), 'cms/work-item');
